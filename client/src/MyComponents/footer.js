      ...
      <div className="container text-center text-md-left">
        <div className="row text-center text-md-left mt-3 pb-3">
          ...
          <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
            ...
            <p>
              <a href="/ocr" className="text-decoration-none">
                Search Substances
              </a>
            </p>
            <p>
              <a href="/discussion" className="text-decoration-none">
                Discussions
              </a>
            </p>
            <p>
          ...
          <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
            ...
            <p>
              <i className="fas fa-home mr-3"></i>MS Ramaiah Institue of
              Technology
            </p>
            <p>
              <i className="fas fa-envelope mr-3"></i> ashishgurram123@gmail.com
            </p>
            <p>
              <i className="fas fa-phone mr-3"></i> +91 8297706028
            </p>
            <p>
              <i className="fas fa-print mr-3"></i> +91 8058826666
            </p>
          </div>
        </div>
